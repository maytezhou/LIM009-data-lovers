...
const getJason = () => {
  fetch(url)
    ...
    .then(data1 => {
      const arrDataWorldBankPeru = data1.PER.indicators;
      const dataPeruSource = data1.PER.dataSource;
      const dataPeruLastUpdated = data1.PER.lastUpdated;
    ...
    `;
      ...
      showInfoData.addEventListener('click', (ab) => {
        ...
        const dataSource = dataPeruSource;
        const lastUpdated = dataPeruLastUpdated;
